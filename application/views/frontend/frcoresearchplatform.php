					...
					<table  width="55%" >
						...
						<tr>
							...
							<td >
								...
								หน่วยงานรับผิดชอบ: <input type="tel" name="" size="22"> เบอร์โทรศัพท์: <input type="tel" name="" size="22"> <br>
								แฟกซ์: <input type="email" name="" size="30"> อีเมล์: <input type="email" name="" size="30"> <br>
								ที่อยู่: <textarea name="" cols="80" rows="3" placeholder=" ที่อยู่" ></textarea><br><br>
								<br>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td >
								...
								ที่อยู่: <textarea name="" cols="80" rows="3" placeholder=" ที่อยู่" ></textarea> <br>
								ผู้ติดต่อประสานงาน: <input type="text" name="" size="18"> เบอร์ผู้ติดต่อประสานงาน: <input type="email" name="" size="16"> <br><br><br>
							</td>
						</tr>
						<tr>
