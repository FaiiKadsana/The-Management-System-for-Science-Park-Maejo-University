  ...
  <div class="navbar-header">
   ...
   <div class="navbar-collapse collapse">
    ...
    <li class="dropdown "><a  data-toggle="dropdown" class="" href="#"><i class="fa fa-caret-square-o-down"></i></i> บริการ <span class="caret"></span></a>
      <ul class="dropdown-menu  " >
        <li class= "bo"><a href="<?php echo base_url("frontend/serviceplatform")?>" style="font-size: 15px;margin-left: 0px;">Service Platform</a></li>
        <li class= "bo"><a  target ="_blank"  href="http://stdb.most.go.th/Home"style="font-size: 15px;margin-left: 0px;">ฐานข้อมูลโครงสร้างพื้นฐาน ภาครัฐ</a></li>  
        ...
        <li class= "bo"><a href="<?php echo base_url("frontend/tbiplatform")?>"style="font-size: 15px;margin-left: 0px;">บ่มเพาะ TBI Platform </a></li>
        <li class= "bo"><a  target ="_blank"  href="http://www.nsp.or.th"style="font-size: 15px;margin-left: 0px;">Privilege Card </a></li>  	 				
      </ul>
    </li>
