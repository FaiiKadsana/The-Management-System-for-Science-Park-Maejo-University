						...
						<td >
							...
							<center>
								...
								<table border="1" width="100%">
									...
									<tr>
										<td width="40%" align="center"><?php echo $row->Co_date;?></td>
										<td align="center"><?php echo $row->Co_date;?></td>
										<td align="center"><?php echo $row->Co_date;?></td>
										<td align="center"><?php echo $row->Co_date;?></td>
										<td align="center"><?php echo $row->Co_date;?></td>
										<td align="center"><?php echo $row->Co_date;?></td>
						...
						<td colspan="2" width="30%" >13.งบประมาณโครงการ 
							...
							<table  border="1" width="100%">
								...
								<tr>
									...
									<td width="30%">
										1. <?php echo $row->Bg_action2;?>&nbsp;&nbsp;&nbsp;&nbsp;1. <?php echo $row->Bg_action3;?><br> 
								...
								<tr>
									...
									<td width="30%"><?php echo $row->Bg_total2;?>&nbsp;&nbsp;&nbsp;<?php echo $row->Bg_total3;?></td>
								...
								<tr>
									...
									<td width="30%">2.<?php echo $row->Co_date;?><br>
										2.1 <?php echo $row->Co_date;?><br>
										2.2 <?php echo $row->Co_date;?><br>
									</td>
									<td width="30%">
										2. <?php echo $row->Co_date;?>&nbsp;&nbsp;&nbsp;&nbsp;2. <?php echo $row->Co_date;?><br> 
										2.1 <?php echo $row->Co_date;?>&nbsp;&nbsp;&nbsp;2.1 <?php echo $row->Co_date;?><br>
										2.2 <?php echo $row->Co_date;?>&nbsp;&nbsp;&nbsp;2.2 <?php echo $row->Co_date;?><br>
									</td>
									<td>
										2.<?php echo $row->Co_date;?><br>
										2.1 <?php echo $row->Co_date;?><br>
										2.2 <?php echo $row->Co_date;?><br>
									</td>
								</tr>
								<tr>
									...
									<td width="30%"><?php echo $row->Co_date;?></td>
									<td width="30%"><?php echo $row->Co_date;?></td>
									<td><?php echo $row->Co_date;?></td>
								</tr>
								<tr>
									<th width="20%">รวมงบประมาณทั้งหมด</th>
									<th width="30%"><?php echo $row->Co_date;?></th>
									<th width="30%"><?php echo $row->Co_date;?></th>
									<th><?php echo $row->Co_date;?></th>
								</tr>
							</table>
							<br>
