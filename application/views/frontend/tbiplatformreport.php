			...
			<table width="100%" >
				...
				<tr>
					<td colspan="3" align="left">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="Tbi_ethnicity" value="อื่นๆ"> อื่นๆ ระบุ
						&nbsp;&nbsp;..........<?php echo $rowtbi->Tbi_ethnicity_etc;?>........... 
					</td>
				</tr>
				<tr>
					<td colspan="3" align="left">
						1.5 ศาสนา&nbsp;&nbsp;<input type="radio" name="Tbi_nationality" value="พุทธ"> พุทธ 
						...
						&nbsp;&nbsp;<input type="radio" name="Tbi_nationality" value="อื่นๆ"> อื่นๆ ระบุ
				...
				<tr>
					<td colspan="3" align="left">
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="Tbi_evidence_register_etc" value="สำเร็จการศึกษา"> สำเร็จการศึกษา เมื่อ ปี พ.ศ. ..........<?php echo $rowtbi->Tbi_year;?>..............
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="Tbi_degree" value="อื่นๆ"> อื่นๆ ระบุ
						&nbsp;&nbsp;.......<?php echo $rowtbi->Tbi_degree_etc;?>........
					</td>
				</tr>
				<tr>
					<td colspan="3" align="left">
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="Tbi_evidence_register_etc" value="กำลังศึกษา"> กำลังศึกษา ในชั้นปีที่ ........<?php echo $rowtbi->Tbi_year;?>.......
						สาขาวิชา.........<?php echo $rowtbi->Tbi_major;?>...........สถาบัน........<?php echo $rowtbi->Tbi_university;?>.........<br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="Tbi_degree" value="มัธยมศึกษาตอนปลาย/ปวช."> มัธยมศึกษาตอนปลาย/ปวช. 
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" name="Tbi_degree" value="อนุปริญญา/ปวส./ปวท."> อนุปริญญา/ปวส./ปวท.  
				...
				<tr>
					<td  colspan="3" align="left">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="Tbi_occupation" value="พนักงานประจำ/ลูกจ้างประจำ บริษัท">พนักงานประจำ/ลูกจ้างประจำ บริษัท.......<?php echo $rowtbi->Tbi_emp_company;?>.......<br>
						...
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="Tbi_occupation" value="ข้าราชการ หรือพนักงานรัฐวิสาหกิจ สังกัด">ข้าราชการ หรือพนักงานรัฐวิสาหกิจ สังกัด......<?php echo $rowtbi->Tbi_official;?>......<br>
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="Tbi_occupation" value="ลูกจ้างรายวัน หรือรับจ้างทั่วไป"> ลูกจ้างรายวัน หรือรับจ้างทั่วไป<br>
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="Tbi_occupation" value="ประกอบวิชาชีพอิสระ (เช่น ทนายความ ฯลฯ)"> ประกอบวิชาชีพอิสระ (เช่น ทนายความ ฯลฯ) โปรดระบุ ...........<?php echo $rowtbi->Tbi_etc;?>......<br>
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="Tbi_occupation" value="ประกอบธุรกิจส่วนตัว"> ประกอบธุรกิจส่วนตัว หรือ เป็นเจ้าของกิจการ<br>
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="Tbi_occupation" value="อื่นๆ"> อื่นๆ โปรดระบุ.......<?php echo $rowtbi->Tbi_etc;?>.......<br>
					</td>
				</tr>
				<tr>
					<td colspan="3" align="left">
				...
				<tr>
					<td colspan="3" align="left">
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="Tbi_owners" value="เป็นเจ้าของ"> เป็นเจ้าของ หรือหุ้นส่วนผู้จัดการในธุรกิจอยู่แล้ว ตั้งแต่ปี พ.ศ.....<?php echo $rowtbi->Tbi_owners_year;?>.....<br>
				...
				<tr>
					<td colspan="3" align="left">
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="B_interest" value="การผลิต"> การผลิต&nbsp;&nbsp;&nbsp;โปรดระบุประเภทสินค้าที่จะผลิต............<?php echo $rowtbi->B_manufacture;?>........<br>
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="B_interest" value="การบริการ"> การบริการ&nbsp;&nbsp;&nbsp;โปรดระบุประเภทสินค้าที่จะผลิต..........<?php echo $rowtbi->B_service;?>........<br>
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="B_interest" value="การค้าส่ง"> การค้าส่ง&nbsp;&nbsp;&nbsp;โปรดระบุประเภทสินค้าที่จะผลิต..........<?php echo $rowtbi->B_wholesale;?>........<br>
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="B_interest" value="การค้าปลีก"> การค้าปลีก&nbsp;&nbsp;&nbsp;โปรดระบุประเภทสินค้าที่จะผลิต........<?php echo $rowtbi->B_retail;?>........
					</td>
				</tr>
				<tr>
					<td colspan="3" align="left">
				...
				<tr>
					<td colspan="3" align="left">
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="B_goal" value="ภายในเดือน"> ภายในเดือน......<?php echo $rowtbi->B_goal_month;?>.......ปี......<?php echo $rowtbi->B_goal_year;?>.....<br>
				...
				<tr>
					<td  colspan="3" align="left">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="B_resources" value="เงินส่วนตัวของท่าน"> เงินส่วนตัวของท่าน ประมาณ ..........<?php echo $rowtbi->B_balance;?>....... บาท<br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="B_resources" value="เงินจากหุ้นส่วน"> เงินจากหุ้นส่วน หรือผู้ร่วมทุน ประมาณ.....<?php echo $rowtbi->B_balance;?>....... บาท ซึ่งคาดว่าจะได้จากแหล่งใดบ้าง<br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="B_source" value="บริษัทหรือกิจการอื่น"> บริษัทหรือกิจการอื่น&nbsp;&nbsp;ระบุ.....<?php echo $rowtbi->B_source_etc;?>.......<br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="B_resources" value="เงินกู้ยืม"> เงินกู้ยืม ประมาณ ......<?php echo $rowtbi->B_balance;?>....... บาท ซึ่งคาดว่าจะได้จากแหล่งใดบ้าง<br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="B_source" value="ธนาคารของรัฐ"> ธนาคารของรัฐ &nbsp;&nbsp;ระบุ........<?php echo $rowtbi->B_source_etc;?>.............
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="B_source" value="ธนาคารพาณิชย์ของเอกชน"> ธนาคารพาณิชย์ของเอกชน&nbsp;&nbsp;ระบุ.........<?php echo $rowtbi->B_source_etc;?>..........<br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="B_source" value="สถาบันการเงินที่ไม่ใช่ธนาคาร"> สถาบันการเงินที่ไม่ใช่ธนาคาร (นันแบงค์ เช่น บริษัทเครดิต, ลิสซิ่ง) &nbsp;&nbsp;ระบุ........<?php echo $rowtbi->B_source_etc;?>..........
					</td>
				</tr>
				<tr>
					<td colspan="3" align="left">
				...
				<tr>
					<td colspan="3" align="left">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" name="Tbi_investment" value="อื่นๆ"> อื่นๆ ระบุ.......<?php echo $rowtbi->Tbi_investment_etc;?>........        
					</td>
				</tr>
				<tr>
					<td colspan="3" align="left">
				...
				<tr>
					<td colspan="3" align="left">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" name="Tbi_train" value="อื่นๆ"> อื่นๆ ระบุ......<?php echo $rowtbi->Tbi_train_etc;?>........       
					</td>
				</tr>
				<tr>
					<td colspan="3" align="left">
				...
				<tr>
					<td colspan="3" align="left">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" name="Tbi_research" value="อื่นๆ"> อื่นๆ ระบุ......<?php echo $rowtbi->Tbi_research_etc;?>......        
					</td>
				</tr>
				<tr>
					<td colspan="3" align="left">
				...
				<tr>
					<td colspan="3" align="left">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" name="Tbi_service" value="อื่นๆ"> อื่นๆ ระบุ........<?php echo $rowtbi->Tbi_service_etc;?>........       
					</td>
				</tr>
				<tr>
					<td colspan="3" align="left">
				...
				<tr>
					<td colspan="3" align="left">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" name="Tbi_counsel" value="อื่นๆ"> อื่นๆ ระบุ .........<?php echo $rowtbi->Tbi_counsel_etc;?>...........        
					</td>
				</tr>
				<tr>
					<td colspan="3" align="left">
				...
				<tr>
					<td colspan="3" align="left">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" name="Tbi_certification" value="ISO"> ISO.....<?php echo $rowtbi->Tbi_certification_iso;?>.... <br>      
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" name="Tbi_certification" value="อื่นๆ"> อื่นๆ ระบุ.......<?php echo $rowtbi->Tbi_certification_etc;?>....... <br>    
					</td>
				</tr>
				<tr>
					<td colspan="3" align="left">
				...
				<tr>
					<td colspan="3" align="left">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" name="Tbi_announce" value="อื่นๆ"> อื่นๆ ระบุ........<?php echo $rowtbi->Tbi_announce_etc;?>.........<br>    
				...
				<tr>
					<td colspan="3" align="left">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" name="Tbi_coordinate" value="อื่นๆ"> อื่นๆ ระบุ.......<?php echo $rowtbi->Tbi_coordinate_etc;?>.........<br>    
				...
				<tr>
					<td colspan="3" align="left">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" name="Tbi_funding" value="อื่นๆ"> อื่นๆ ระบุ........<?php echo $rowtbi->Tbi_funding_etc;?>.......<br>    
					</td>
				</tr>
				<tr>
					<td colspan="3" align="left">
				...
				<tr>
					<td colspan="3" align="left">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" name="Tbi_asset" value="อื่นๆ"> อื่นๆ ระบุ.......<?php echo $rowtbi->Tbi_asset_etc;?>........<br>    
					</td>
				</tr>
				<tr>
					<td colspan="3" align="center">
									...
									<table>
										<tr>
											<td colspan="2" align="left">
												...
												<input type="checkbox" name="Tbi_evidence_register" value="สำเนาบัตรประชาชน  เลขประจำตัว"> สำเนาบัตรประชาชน  เลขประจำตัว .....<?php echo $rowtbi->Tbi_code;?>...<br> 
												<input type="checkbox" name="Tbi_evidence_register" value="สำเนาหลักฐานการศึกษา วุฒิการศึกษา"> สำเนาหลักฐานการศึกษา วุฒิการศึกษา.....<?php echo $rowtbi->Tbi_education;?>....<br> 
												<input type="checkbox" name="Tbi_evidence_register" value="เอกสารรับรองการทำงาน  ชื่อหน่วยงาน"> เอกสารรับรองการทำงาน  ชื่อหน่วยงาน ....<?php echo $rowtbi->Tbi_department;?>....<br> 
											</td>
											<td align="left">
												<p><b>การนัดหมาย</b></p>
										...
										<tr><td colspan="3" align="left">
											...
											<input type="checkbox" name="Tbi_evidence_register" value="ข้อมูล Idea/Innovation/Technology เพิ่มเติม"> ข้อมูล Idea/Innovation/Technology เพิ่มเติม<br> <br>
										</td></tr>
									</table><br>
								</td>
							</tr>
							...
							<tr>
								...
								<br>
									...
									<table>
										<tr>
											<td colspan="3" align="left">
												<input type="checkbox" name="Tbi_ practicality" value="มีผลงานวิจัยสนับสนุน"> มีผลงานวิจัยสนับสนุน<br>
												<input type="checkbox" name="Tbi_ practicality" value="เป็นไปได้และถ้าเป็นไปได้ควรมีต้นแบบ (Prototype) หรือผลิตภัณฑ์แล้ว"> เป็นไปได้และถ้าเป็นไปได้ควรมีต้นแบบ (Prototype) หรือผลิตภัณฑ์แล้ว<br>
												<input type="checkbox" name="Tbi_ practicality" value="ผู้ประกอบการต้องมีความรู้  ความเข้าใจในเทคโนโลยีที่ใช้เป็นอย่างดี"> ผู้ประกอบการต้องมีความรู้  ความเข้าใจในเทคโนโลยีที่ใช้เป็นอย่างดี<br>
												<input type="checkbox" name="Tbi_ practicality" value="มีแนวคิดในการปรับปรุงเทคโนโลยีเพื่อให้เกิดผลิตภัณฑ์ที่หลากหลายตามความต้องการของลูกค้า"> มีแนวคิดในการปรับปรุงเทคโนโลยีเพื่อให้เกิดผลิตภัณฑ์ที่หลากหลายตามความต้องการของลูกค้า<br>
												<input type="checkbox" name="Tbi_ practicality" value="มีทุนทรัพย์ในการเริ่มต้นธุรกิจ"> มีทุนทรัพย์ในการเริ่มต้นธุรกิจ<br>
											</td>
										</tr>
									</table><br>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(ลายมือชื่อ) ...................................<br>
