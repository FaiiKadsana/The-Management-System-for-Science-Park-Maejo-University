			...
			<form id="" method="post" class="form-horizontal" action="">
				<table >
					<tr>
						...
						<td><a href="<?php echo base_url("frontend/irtcplatformreport")?>"><button class="btn btn-success" type="button" >ดาว์นโหลดแบบฟอร์ม</button></a></td>
					</tr>
				</table>
			</form>
		</center>
			...
			<div class="panel-body">
				<table class="table table-striped">
					...
					<tr class="bg-success">
						...
						<td><a href="<?php echo base_url("frontend/irtcplatformreport")?>"><button type="button" class="btn btn-info" ><i class="fa fa-download"></i>ดาว์นโหลด</button></a></td> 
