 ...
 <form method="post" action="<?php echo $action; ?>" enctype="multipart/form-data">
 	<div class="container">
 		...
 		<!-- start row -->
 		<div class="row">
 			<div class="col-lg-offset-1 col-lg-2 col-md-2 col-sm-2"><img src='<?php echo base_url("asset/images/mju_logo.jpg") ?>' width='30%' height='10%' ></div>
 			<div class="col-lg-offset-1 col-lg-6 col-md-6 col-sm-6"><p>โครงการการบ่มเพาะผู้ประกอบการเทคโนโลยี  มหาวิทยาลัยแม่โจ้</p><p>ภายใต้โครงการอุทยานวิทยาศาสตร์  มหาวิทยาลัยแม่โจ้</p></div>
 			<div class=" col-lg-2 col-md-2 col-sm-2"><img src='<?php echo base_url("asset/images/N.jpg") ?>' width='40%' height='30%'></div>
 		</div>
 		<!-- Ent row -->
 		<!-- start row -->
 		<div class="row">
 			<div class="col-lg-offset-4 col-lg-6 col-md-offset-4 col-md-6 col-sm-offset-4 col-sm-6 ">
 		...
 		<div class="row">
 			<div class="col-lg-offset-9 col-lg-3col-md-offset-9 col-md-3 col-sm-offset-9 col-sm-3 ">
 				<input type="file" name="Tbi_picture" >
 			</div>
 		</div>
 		<!-- Ent row -->
 		<!-- start row -->
 	...
 	<div class="row">
 		<div class="col-lg-12 col-md-12 col-sm-12">
 			...
 			&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="Tbi_owners" value="ไม่เคยเป็นเจ้าของธุรกิจ"> ไม่เคยเป็นเจ้าของธุรกิจ และไม่ได้เป็นทายาทธุรกิจ
 		</div>
 	</div>
 	<!-- Ent row -->
 	<!-- start row -->
 	...
 	<div class="row">
 		<div class="col-lg-12 col-md-12 col-sm-12">
 			...
 			&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="B_concept" value="มีโครงการหรือแนวคิดเกี่ยวกับธุรกิจที่จะลงทุนอยู่แล้ว"> มีโครงการหรือแนวคิดเกี่ยวกับธุรกิจที่จะลงทุนอยู่แล้ว
 		</div>
 	</div>
 	<!-- Ent row -->
 	<!-- start row -->
 	...
 	<div class="row">
 		<div class="col-lg-12 col-md-12 col-sm-12">
 			...
 			<input type="text" size="30" name="B_emp_sum" > คน
 		</div>
 	</div>
 	<!-- Ent row -->
 	<!-- start row -->
 	...
 	<div class="row">
 		<div class="col-lg-12 col-md-12 col-sm-12">
 			<b style="color:red;">*หมายเหตุ โปรดจำหมายเลขแบบฟอร์ม</b>&nbsp;&nbsp;เลขที่แบบฟอร์ม: <label type="" size="20" name="Tbi_id3"><?php echo  $random; ?><input type="hidden" name="random" value="<?php echo  $random; ?>"></b>
 		</div>
 	</div>
 	<!-- Ent row -->
