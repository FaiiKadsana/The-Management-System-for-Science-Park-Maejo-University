			...
			<div class="col-sm-12">
				<center>
					<table width="70%">
						<tr>
							<td width="30%"></td>
							<td align="right"><b style="color:red;">*หมายเหตุ โปรดจำหมายเลขแบบฟอร์ม</b>&nbsp;&nbsp;เลขที่แบบฟอร์ม: <input type="text" size="20" name="Tbi_id3"></td>
						</tr>
					</table>
				</center>
			</div>
			...
			<div class="col-sm-12 ">
				...
				<center>
					<table width="70%" >
						...
						<tr>
							<td colspan="2" align="left">
								วันที่:<input type="date" name="Tbi_date"  >
							</td>
							<td align="right">เลขที่: <input type="text" name="Tbi_id4" size="20" ></td>
						</tr>
						<tr>
						...
						<tr>
							...
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ชื่อ: <input type="text" size="30" name="Tbi_name" >
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;นามสกุล: <input type="text" size="30" name="Tbi_lastname" >
						</td>
					</tr>
					<tr>
						<td colspan="3" align="left">
							&nbsp;&nbsp;&nbsp;&nbsp;1.2
							เลขประจำตัวประชาชน: <input type="text" size="50" name="Tbi_code" >
						</td>
					</tr>
					<tr>
						<td colspan="3" align="left">
					...
					<tr>
						<td colspan="3" align="left">
							&nbsp;&nbsp;&nbsp;&nbsp;1.7
							โทรศัพท์ที่ติดต่อสะดวก: <input type="tel" size="10" name="Tbi_tell" >&nbsp;&nbsp;&nbsp;&nbsp;
							โทรสาร: <input type="text" size="10" name="Tbi_fax" >&nbsp;&nbsp;&nbsp;&nbsp;
							มือถือ: <input type="tel" size="10" name="Tbi_phone" >&nbsp;&nbsp;&nbsp;&nbsp;
							E-mail: <input type="email" size="20" name="Tbi_mail" >&nbsp;&nbsp;&nbsp;&nbsp;
						</td>
					</tr>
					<tr>
						<td colspan="3" align="left">
					...
					<tr>
						<td colspan="3" align="left">
							&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="" value="กำลังศึกษา"> กำลังศึกษา ในชั้นปีที่ <input type="text" size="20" name="Tbi_year" >
							สาขาวิชา <input type="text" size="20" name="Tbi_major" > สถาบัน <input type="text" size="20" name="Tbi_university" ><br>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" name="Tbi_degree" value="มัธยมศึกษาตอนปลาย/ปวช."> มัธยมศึกษาตอนปลาย/ปวช. 
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" name="Tbi_degree" value="อนุปริญญา/ปวส./ปวท."> อนุปริญญา/ปวส./ปวท.  
					...
					<tr>
						<td  colspan="3" align="left">
							...
							&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="Tbi_occupation" value="ประกอบวิชาชีพอิสระ (เช่น ทนายความ ฯลฯ)"> ประกอบวิชาชีพอิสระ (เช่น ทนายความ ฯลฯ)<input type="text" size="20" name="" placeholder="โปรดระบุ"><br>
					...
					<tr>
						<td  colspan="3" align="left">
							...
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="B_source" value="บริษัทหรือกิจการอื่น"> บริษัทหรือกิจการอื่น&nbsp;&nbsp;<input type="text" size="30" name="" placeholder="ระบุ" ><br>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="B_resources" value="เงินกู้ยืม"> เงินกู้ยืม ประมาณ <input type="text" size="20" name="" > บาท ซึ่งคาดว่าจะได้จากแหล่งใดบ้าง<br>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							...
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="B_source" value="ธนาคารของรัฐ"> ธนาคารของรัฐ &nbsp;&nbsp;<input type="text" size="30" name="" placeholder="ระบุ" >
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="B_source" value="ธนาคารพาณิชย์ของเอกชน"> ธนาคารพาณิชย์ของเอกชน&nbsp;&nbsp;<input type="text" size="30" name="" placeholder="ระบุ" ><br>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="B_source" value="สถาบันการเงินที่ไม่ใช่ธนาคาร"> สถาบันการเงินที่ไม่ใช่ธนาคาร (นันแบงค์ เช่น บริษัทเครดิต, ลิสซิ่ง) &nbsp;&nbsp;<input type="text" size="30" name="" placeholder="ระบุ" >
						</td>
					</tr>
					<tr>
						<td colspan="3" align="left">
					...
					<tr>
						<td colspan="3" align="left">
							&nbsp;&nbsp;&nbsp;&nbsp;3.6
							การขอใช้บริการห้องปฏิบัติการ<input type="text" size="30" name="Tbi_lab" placeholder="ระบุ" >      
						</td>
					</tr>
					<tr>
						<td colspan="3" align="left">
										...
										<table>
											<tr>
												<td colspan="2" align="left">
													...
													<input type="checkbox" name="Tbi_evidence_ register" value="ใบสมัคร"> ใบสมัคร<br>
													<input type="checkbox" name="Tbi_evidence_ register" value="สำเนาบัตรประชาชน  เลขประจำตัว"> สำเนาบัตรประชาชน  เลขประจำตัว <input type="text" size="15" name="" ><br> 
													<input type="checkbox" name="Tbi_evidence_ register" value="สำเนาหลักฐานการศึกษา วุฒิการศึกษา"> สำเนาหลักฐานการศึกษา วุฒิการศึกษา<input type="text" size="15" name="" ><br> 
													<input type="checkbox" name="Tbi_evidence_ register" value="เอกสารรับรองการทำงาน  ชื่อหน่วยงาน"> เอกสารรับรองการทำงาน  ชื่อหน่วยงาน <input type="text" size="15" name="" ><br> 
												</td>
												<td align="left">
													<p><b>การนัดหมาย</b></p>
							...
							<table border="1" width="80%">
								<tr>
									<td colspan="3" align="center">
										...
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(ลายมือชื่อ) <input type="text" size="30" name="Tbi_inspector" ><br>
