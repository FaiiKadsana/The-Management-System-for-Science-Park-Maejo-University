       ...
       <div class="panel panel-warning">
        ...
        <div class="col-sm-5">
          ...
          <table class="table table-bordered">
            ...
            <tr>
             <td ><button type="button" class="btn btn-warning" data-toggle="modal" data-target=".bs-example-modal-lg-editproject_irct"><i class="fa fa-wrench"></i> แก้ไข</button></td>  
           </tr>
         </table>
         <!-- End -->
         ...
         <form id="" method="post" class="form-horizontal" action="">
          ...
          <div class="modal fade bs-example-modal-lg-editproject_irtc" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
