  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-sm-12">
       ...
       <ol class="breadcrumb">
         <li><i class="active"> <i class="fa fa-home"></i></i><a href="<?php echo base_url("backend/index/display")?>">Home</a></li><li><i class="fa fa-pencil"></i><a href="<?php echo base_url("backend/research")?>">จัดการข้อมูลผลงานวิจัย</a></li>
       </ol>
     </div>
   </div></br>
   <!-- /.row -->
