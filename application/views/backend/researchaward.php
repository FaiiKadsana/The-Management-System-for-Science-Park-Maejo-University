            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <ol class="breadcrumb">
                             <li><i class="active"> <i class="fa fa-home"></i></i><a href="<?php echo base_url("backend/index")?>">Home</a></li><li><i class="fa fa-pencil"></i><a href="<?php echo base_url("backend/researchaward")?>">จัดการข้อมูลรางวัลงานวิจัย</a></li>
                        </ol>
                    </div>
                </div></br>
                <!-- /.row -->
