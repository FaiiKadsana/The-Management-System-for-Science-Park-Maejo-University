    ...
    <div class="row ">
      <div class="col-sm-12">
       ...
       <ol class="breadcrumb">
         ...
         <li><i class="fa fa-file"></i> <a href="<?php echo base_url("backend/frcoresearch")?>">Form</a></li>
       </ol>
     </div>
   </div></br>
   <!-- /.row -->
          ...
          <div class="col-sm-12">
            <center>
              <table width="100%">
                <tr>
                  <td width="30%"></td>
                  <td align="center"><b style="color:red;">*หมายเหตุ โปรดจำหมายเลขแบบฟอร์ม</b>&nbsp;&nbsp;เลขที่แบบฟอร์ม: <label type="" size="20" name="Co_id"><?php echo  $random; ?><input type="hidden" name="random" value="<?php echo  $random; ?>"></td>
                </tr>
              </table>
            </center>
          </div>
