            ...
            <div class="panel-body">
             ...
             <div class="row">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-4">
                  <input type="file" name="Rec_picture" >
                </div>
...
<div class="panel panel-warning">
  ...
  <div class="panel-body">
    ...
    <div class="col-lg-4">
      <input type="text" class="form-control" name="Re_ notes"   />
    </div>
  </div>
