...
<head>
    ...
    <title>The Science Park MJU</title>
    ...
    <!-- Morris Charts CSS -->
    <link href="<?php echo base_url("asset2/css/plugins/morris.css"); ?>" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="<?php echo base_url("asset2/font-awesome/css/font-awesome.min.css"); ?>" rel="stylesheet" type="text/css">
