...
class Frtbi extends CI_Controller {
	...
	public function index(){
		...
		if( $_SERVER["REQUEST_METHOD"] == "POST")
		{
			...
			$insertTbiperson["Tbi_picture"]=$this->input->post("Tbi_picture");
			$insertTbiperson["Tbi_title"]=$this->input->post("Tbi_title");
			$insertTbiperson["Tbi_name"]=$this->input->post("Tbi_name");
			...
			$this->load->view('backend/recaptchalib');
			...
			if($insertTbi["Tbi_date_register"]=="" || $insertTbi["Tbi_date"]=="" 
				|| $insertTbi["Tbi_name"]==""|| $insertTbi["Tbi_evidence_register"]==""|| $insertTbi["Tbi_code"]==""
				|| $insertTbi["Tbi_education"]=="" || $insertTbi["Tbi_appointment"]=="" || $insertTbi["Tbi_date_concept"]==""
				|| $insertTbi["Tbi_date_meet"]=="" || $insertTbi["Tbi_practicality"]=="" || $insertTbi["Tbi_inspector"]=="" 
				|| $insertTbi["Tbi_date_inspect"]==""){

				echo "<meta http-equiv='Content-Type' content='text/html; charset=utf-8' />";
			echo "<script>alert('กรุณากรอกรายละเอียดให้ครบคะ');</script>";
			redirect('backend/frtbi', 'refresh');
		}
		else if($insertTbibusiness["B_concept"]=="" || $insertTbibusiness["B_interest"]=="" || $insertTbibusiness["B_business_plan"]=="" 
			|| $insertTbibusiness["B_resources"]==""){
	...
	else if($insertTbiperson["Tbi_picture"]=="" || $insertTbiperson["Tbi_title"]=="" || $insertTbiperson["Tbi_name"]=="" || $insertTbiperson["Tbi_lastname"]==""
		|| $insertTbiperson["Tbi_code"]=="" || $insertTbiperson["Tbi_tell"]==""|| $insertTbiperson["Tbi_phone"]==""|| $insertTbiperson["Tbi_mail"]=="" ){
...
else if($insertTbiperson1["Tbi_education"]==""  ){
...
$data['action']=site_url('backend/frtbi/index/');
$this->load->view('backend/frtbi',$data);
